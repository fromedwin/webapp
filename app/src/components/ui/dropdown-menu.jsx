  ...
  ({ className, sideOffset = 6, container, ...props }, ref) => {
    const content = (
      <DropdownMenuPrimitive.Content
        ...
        collisionPadding={8}
        className={cn(
          'z-[1000] min-w-[12rem] overflow-hidden rounded-md border border-border bg-popover p-1 text-popover-foreground shadow-md',
          className,
        )}
        {...props}
      />
    ...
    return <DropdownMenuPrimitive.Portal container={container}>{content}</DropdownMenuPrimitive.Portal>;
  },
);
